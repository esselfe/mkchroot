...
mkdir -pv usr/lib
ln -sfv lib lib64
cp -rpdv /lib/* usr/lib | sed '/\/lib\/modules/d;/\/lib\/firmware/d'
mv -v usr/lib/ld-linux* lib
...
cp -v /usr/lib/libacl.so.1 usr/lib
cp -v /usr/lib/libattr.so.1 usr/lib
cp -v /usr/lib/libcrack.so.2 usr/lib
cp -v /usr/lib/libnss_systemd.so.2 usr/lib
cp -v /usr/lib/libcrypt.so.1 usr/lib

mkdir -v usr/share
cp -rpv /usr/share/cracklib usr/share
...
cp -fv /usr/bin/{dircolors,useradd,userdel,groupadd,groupdel,mkdir,passwd} bin
cp -fv /usr/bin/{grpconv,pwconv,[,basename,dirname,false,true,uniq,test} bin
cp -fv /usr/bin/{head,tail,install,md5sum,sha1sum,sha224sum,sha256sum} bin
cp -fv /usr/bin/{sha384sum,sha512sum,shuf,sleep,sort,stat,touch,whoami} bin

rm -v bin/{bashbug,dmesg,findmnt,kmod,login,lsfd,lsh,lsmod,lvis,lvu,more}
rm -v bin/{mount,mountpoint,umount,wdctl}

mkdir -v etc
cp -v /etc/ld.so.conf etc
mkdir etc/ld.so.conf.d
cp -pv /etc/inputrc etc
cp -pv /etc/login.defs etc
cp -pv /etc/nsswitch.conf etc
cp -rpdv /etc/pam.d etc
cp -rpv /etc/security etc
echo 'export PATH=/bin:/usr/bin' > etc/profile
echo 'export PS1="\t\u@\l:\w\\$ "' >> etc/profile
echo 'export LANG=en_US.UTF-8' >> etc/profile
echo -e "export LS_COLORS='rs=0:di=01;34:ln=01;36:mh=00:pi=40;33:so=01;35:"\
"do=01;35:bd=40;33;01:cd=40;33;01:or=40;31;01:mi=00:su=37;41:sg=30;43:"\
"ca=00:tw=30;42:ow=34;42:st=37;44:ex=01;32:*.tar=01;31:*.tgz=01;31:"\
...
"*.dwm=01;31:*.esd=01;31:*.avif=01;35:*.jpg=01;35:*.jpeg=01;35:*.mjpg=01;35:"\
...
"*.mpeg=01;35:*.m2v=01;35:*.mkv=01;35:*.webm=01;35:*.webp=01;35:*.ogm=01;35:"\
...
"*.opus=00;36:*.spx=00;36:*.xspf=00;36:*~=00;90:*#=00;90:*.bak=00;90:"\
"*.old=00;90:*.orig=00;90:*.part=00;90:*.rej=00;90:*.swp=00;90:*.tmp=00;90:"\
"*.dpkg-dist=00;90:*.dpkg-old=00;90:*.ucf-dist=00;90:*.ucf-new=00;90:"\
"*.ucf-old=00;90:*.rpmnew=00;90:*.rpmorig=00;90:*.rpmsave=00;90:'"\
	>> etc/profile
